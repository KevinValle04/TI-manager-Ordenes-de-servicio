...
- generic [ref=e1]:
  ...
  - dialog [ref=e200]:
    - generic [ref=e201]:
      - generic [ref=e202]:
        - generic [ref=e203]: Documentos - Colaborador-kw1k9q-1758823660641
        - button "Close" [ref=e204] [cursor=pointer]
      - generic [ref=e206]:
        - generic [ref=e207]:
          - heading "Lista de Documentos" [level=3] [ref=e208]
          - button "plus Cancelar" [ref=e209] [cursor=pointer]:
            - img "plus" [ref=e211] [cursor=pointer]:
              - img [ref=e212] [cursor=pointer]
            - generic [ref=e215] [cursor=pointer]: Cancelar
        - generic [ref=e216]:
          - generic [ref=e219]: Nuevo Documento
          - generic [ref=e221]:
            - generic [ref=e222]:
              - generic [ref=e224]:
                - generic "Nombre del documento" [ref=e226]: "* Nombre del documento"
                - textbox "* Nombre del documento" [active] [ref=e230]: Contrato de Trabajo
              - generic [ref=e232]:
                - generic "Fecha de vencimiento (opcional)" [ref=e234]:
                  - text: Fecha de vencimiento (opcional)
                  - img "question-circle" [ref=e235]:
                    - img [ref=e236]
                - generic [ref=e243]:
                  - textbox "Fecha de vencimiento (opcional) question-circle" [ref=e244]
                  - generic:
                    - img "calendar":
                      - img
            - generic [ref=e246]:
              - generic "Documento" [ref=e248]: "* Documento"
              - 'button "inbox Haga clic o arrastre un archivo a esta área Archivos permitidos: PDF, JPG, PNG, GIF, WEBP" [ref=e254] [cursor=pointer]':
                - generic [ref=e256] [cursor=pointer]:
                  - paragraph [ref=e257] [cursor=pointer]:
                    - img "inbox" [ref=e258] [cursor=pointer]:
                      - img [ref=e259] [cursor=pointer]
                  - paragraph [ref=e261] [cursor=pointer]: Haga clic o arrastre un archivo a esta área
                  - paragraph [ref=e262] [cursor=pointer]: "Archivos permitidos: PDF, JPG, PNG, GIF, WEBP"
            - button "Guardar Documento" [ref=e268] [cursor=pointer]:
              - generic [ref=e269] [cursor=pointer]: Guardar Documento
```