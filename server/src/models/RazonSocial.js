...
var DireccionEnvioSchema = new mongoose_1.Schema({
    nombre: { type: String, },
    direccion: { type: String, },
    telefono: { type: String },
    contacto: { type: String }
});
var RazonSocialSchema = new mongoose_1.Schema({
    nombre: { type: String, },
...
exports.default = mongoose_1.default.model('RazonSocial', RazonSocialSchema);
